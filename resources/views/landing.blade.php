        ...
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <div class="flex items-center">
                <a href="/" class="flex items-center transform transition-transform duration-300 hover:scale-105 group">
                    ...
                    <h1 class="text-2xl font-semibold text-white group-hover:text-yellow-300 transition-colors duration-300">Library System</h1>
                </a>
            </div>
        ...
        <div class="container mx-auto text-center relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 ease-in-out group relative overflow-hidden">
                    ...
                    <img src="{{ asset('images/dnz.jpg') }}" alt="Dan Andrei S. Macasa" class="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-purple-100 transition-transform group-hover:scale-110">
