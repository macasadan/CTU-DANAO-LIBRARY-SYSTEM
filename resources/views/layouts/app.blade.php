...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen">
        ...
        {{-- Sidebar --}}
        <aside id="sidebar"
            class="fixed top-0 left-0 z-30 w-64 h-screen overflow-y-auto transition-transform duration-300 transform -translate-x-full bg-white border-r md:translate-x-0">
            <div class="flex flex-col min-h-screen">
                ...
                {{-- Navigation Links --}}
                <!-- Navigation Links -->
                <nav class="p-10 space-y-2 flex-grow overflow-y-auto pb-20">
