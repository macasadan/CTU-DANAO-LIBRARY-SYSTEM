    ...
    <div class="container mx-auto text-center relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 ease-in-out group relative overflow-hidden">
                ...
                <img src="<?php echo e(asset('images/dan.png')); ?>" alt="Dan Andrei S. Macasa" class="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-purple-100 transition-transform group-hover:scale-110">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="group">
                <div class="relative overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                    ...
                    <img src="<?php echo e(asset('images/librarian.jpg')); ?>" alt="Sarah Jean N. Jamero" class="w-full h-64 object-cover object-center">
            ...
            <div class="group">
                <div class="relative overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                    <div class="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <img src="<?php echo e(asset('images/alvin.jpg')); ?>" alt="Alvin Kris Hermosilla" class="w-full h-50 object-cover object-center">
                    <div class="p-6 relative z-10">
...
</html><?php /**PATH C:\xampp\htdocs\git\Final-Library-System-Capstone-1\final-1\resources\views/landing.blade.php ENDPATH**/ ?>