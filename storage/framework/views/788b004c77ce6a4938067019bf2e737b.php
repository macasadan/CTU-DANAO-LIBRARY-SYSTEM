...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <section class="relative bg-cover bg-center text-white py-32"
        style="background-image: url('<?php echo e(asset('images/bg2.jpg')); ?>');">
        ...
        <div class="container mx-auto relative z-10 text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center gap-4">
                ...
                <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-gray-100 text-blue-700 font-medium rounded-lg shadow-lg hover:bg-gray-200 hover:shadow-xl transition duration-300">
                    Become a Member
                </a>
            </div>
        </div>
        ...
        <div class="container mx-auto text-center relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 ease-in-out group relative overflow-hidden">
                    ...
                    <img src="<?php echo e(asset('images/jehan.jpg')); ?>" alt="Jehan D. Bombio" class="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-blue-100 transition-transform group-hover:scale-110">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 ease-in-out group relative overflow-hidden">
                    ...
                    <img src="<?php echo e(asset('images/jun.jpg')); ?>" alt="Rosalio Ligaray Jr." class="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-green-100 transition-transform group-hover:scale-110">
                ...
                <!-- Team Member 3: Dan Andrei Y. Macasa -->
                <div class="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 ease-in-out group relative overflow-hidden">
                    ...
                    <img src="<?php echo e(asset('images/dnz.jpg')); ?>" alt="Dan Andrei S. Macasa" class="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-purple-100 transition-transform group-hover:scale-110">
                    <h4 class="text-xl font-semibold text-purple-800 mb-2">Dan Andrei Y. Macasa</h4>
                    ...
                    <div class="mt-4 flex justify-center space-x-3 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <a href="https://github.com/macasadan" target="_blank" rel="noopener noreferrer" class="text-purple-500 hover:text-purple-700">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                            </svg>
                        </a>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 ease-in-out group relative overflow-hidden">
                    ...
                    <img src="<?php echo e(asset('images/tatan.jpg')); ?>" alt="Christian Dave A. Milan" class="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-orange-100 transition-transform group-hover:scale-110">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 transform hover:-translate-y-4 hover:shadow-2xl transition-all duration-300 ease-in-out group relative overflow-hidden">
                    ...
                    <img src="<?php echo e(asset('images/papo.jpg')); ?>" alt="Lorenze Supapo" class="w-32 h-32 rounded-full mx-auto mb-4 border-4 border-teal-100 transition-transform group-hover:scale-110">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="group">
                    <div class="relative overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <img src="<?php echo e(asset('images/headlibrarian.png')); ?>" alt="Sarah Jean N. Jamero" class="w-full h-50 object-cover object-center">
                ...
                <div class="group">
                    <div class="relative overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                        <div class="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <img src="<?php echo e(asset('images/staff1.png')); ?>" alt="Alvin Kris Hermosilla" class="w-full h-50 object-cover object-center">
                        <div class="p-6 relative z-10">
                ...
                <div class="group">
                    <div class="relative overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                        <div class="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <img src="<?php echo e(asset('images/staff3.png')); ?>" alt="Marivel C. Meca" class="w-full h-50 object-cover object-center">
                        <div class="p-6 relative z-10">
                ...
                <div class="group">
                    <div class="relative overflow-hidden bg-white rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                        <div class="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <img src="<?php echo e(asset('images/staff4.png')); ?>" alt="Marianita F. Balili" class="w-full h-50 object-cover object-center">
                        <div class="p-6 relative z-10">
...
</html><?php /**PATH C:\Users\Admin\Documents\GitHub\CTU-DANAO-LIBRARY-SYSTEM\resources\views/landing.blade.php ENDPATH**/ ?>