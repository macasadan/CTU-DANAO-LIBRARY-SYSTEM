    ...
    reservationForm.addEventListener('submit', function(e) {
        ...
        function checkRoomAvailability() {
            ...
            if (roomId && startTime && endTime) {
                fetch('<?php echo e(route("reservations.check-availability")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git\Final-Library-System-Capstone-1\final-1\resources\views/reservations/create.blade.php ENDPATH**/ ?>