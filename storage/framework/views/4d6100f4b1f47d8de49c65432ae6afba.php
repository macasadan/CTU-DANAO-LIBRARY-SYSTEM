...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-medium text-gray-900"><?php echo e($borrow->user->name); ?></div>
                        <div class="text-sm text-gray-500">ID: <?php echo e($borrow->id_number); ?></div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900"><?php echo e($borrow->book->title); ?></div>
                        <div class="text-sm text-gray-500">ISBN: <?php echo e($borrow->book->isbn); ?></div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900"><?php echo e($borrow->course); ?></div>
                        <div class="text-sm text-gray-500"><?php echo e($borrow->department); ?></div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <?php echo e($borrow->created_at->format('M d, Y H:i')); ?>

                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button onclick="approveBorrow(this.dataset.borrowId)"
                            class="text-green-600 hover:text-green-900 mr-3" data-borrow-id="<?php echo e($borrow->id); ?>">Approve</button>
                        <button onclick="showRejectModal(this.dataset.borrowId)"
                            class="text-red-600 hover:text-red-900" data-borrow-id="<?php echo e($borrow->id); ?>">Reject</button>
                    </td>
                </tr>
        ...
        <div class="px-6 py-4">
            <?php echo e($pendingBorrows->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LARAVEL\tatan\CTU-DANAO-LIBRARY-SYSTEM\resources\views/admin/borrows/pending.blade.php ENDPATH**/ ?>