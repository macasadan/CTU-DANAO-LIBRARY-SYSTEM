            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                        <?php echo e($occupancy >= $maxCapacity ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                        <?php echo e($occupancy); ?>/<?php echo e($maxCapacity); ?> PCs
                    </span>
                </div>
                <div class="mt-4">
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-gradient-to-r from-blue-600 to-orange-500 h-2 rounded-full"
                            style="width: <?php echo e(($occupancy / $maxCapacity) * 100); ?>%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-medium text-gray-900"><?php echo e($maxCapacity - $occupancy); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="border-l-4 border-green-500 bg-green-50 p-6 rounded-r-lg">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                            <?php echo e(ucfirst($currentUserSession->status)); ?>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <div>
                            ...
                            <p class="mt-1 font-medium"><?php echo e($currentUserSession->start_time); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">End Time</p>
                            <p class="mt-1 font-medium"><?php echo e($currentUserSession->end_time); ?></p>
                        </div>
                        <div class="sm:col-span-2">
                            <p class="text-sm text-gray-500">Purpose</p>
                            <p class="mt-1 font-medium"><?php echo e($currentUserSession->purpose); ?></p>
                        </div>
                    </div>
                </div>
                <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git\Final-Library-System-Capstone-1\final-1\resources\views/pc-room/index.blade.php ENDPATH**/ ?>