...
<div class="flex-1 min-h-screen bg-gray-50">
    <div class="p-6">
        ...
        <div class="overflow-hidden bg-white rounded-lg shadow">
            <?php $__empty_1 = true; $__currentLoopData = $borrowedBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div id="borrowed-book-<?php echo e($borrow->id); ?>"
                class="p-6 transition-colors border-b border-gray-200 hover:bg-gray-50">
                <div class="flex items-start justify-between">
                    <div class="flex-1 space-y-4">
                        <!-- Book Details -->
                        <div class="flex flex-col gap-2">
                            <h3 class="text-xl font-semibold text-gray-900"><?php echo e($borrow->book->title); ?></h3>
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                <div>
                                    <span class="text-sm font-medium text-gray-500">Author</span>
                                    <p class="mt-1 text-gray-900"><?php echo e($borrow->book->author); ?></p>
                                </div>
                                <div>
                                    <?php if($borrow->book->categories->isNotEmpty()): ?>
                                    <span class="text-sm font-medium text-gray-500">Categories</span>
                                    <p class="mt-1 text-gray-900">
                                        <?php $__currentLoopData = $borrow->book->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-gray-900"><?php echo e($borrow->id_number); ?></p>
                                </div>
                                <div>
                                    <span class="text-sm font-medium text-gray-500">Course</span>
                                    <p class="mt-1 text-gray-900"><?php echo e($borrow->course); ?></p>
                                </div>
                                <div>
                                    <span class="text-sm font-medium text-gray-500">Department</span>
                                    <p class="mt-1 text-gray-900"><?php echo e($borrow->department); ?></p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-gray-900">
                                        <?php echo e(\Carbon\Carbon::parse($borrow->borrow_date)->format('M d, Y')); ?>

                                    </p>
                                </div>
                                <div>
                                    <span class="text-sm font-medium text-gray-500">Due Date</span>
                                    <p class="mt-1 <?php echo e(\Carbon\Carbon::parse($borrow->due_date)->isPast() ? 'text-red-600' : 'text-gray-900'); ?>">
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php echo e($borrow->status === 'approved' ? 'bg-green-100 text-green-800' : 
                    ...
                    <div class="ml-4">
                        <button
                            ...
                            data-borrow-id="<?php echo e($borrow->id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git\Final-Library-System-Capstone-1\final-1\resources\views/borrowed_books.blade.php ENDPATH**/ ?>