<?php $__env->startSection('title', 'Discussion Room Reservation History'); ?>
<?php $__env->startSection('header', 'Discussion Room Reservation Logs'); ?>
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="mb-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
        <form action="<?php echo e(route('super-admin.history')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <!-- Search Input -->
            <div>
            ...
            <!-- Reset Button -->
            <div class="flex items-end">
                <a href="<?php echo e(route('super-admin.history')); ?>" class="w-full px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 text-center">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-200">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900">
                        <?php echo e($reservation->purpose ?? 'N/A'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (downloadPdfButton) {
        downloadPdfButton.addEventListener('click', function() {
            ...
            // Select table rows more carefully
            const tableRows = document.querySelectorAll('#reservationsTable tbody tr:not(:last-child)');
...
<?php echo $__env->make('layouts.superadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git\Final-Library-System-Capstone-1\final-1\resources\views/super-admin/history.blade.php ENDPATH**/ ?>