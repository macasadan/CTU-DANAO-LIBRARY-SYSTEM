    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-l-4 border-green-500">
            <div class="p-6">
                ...
                <a href="<?php echo e(route('admin.books.index')); ?>" class="w-full block text-center bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors">
                    Manage Books
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-l-4 border-blue-500">
            <div class="p-6">
                ...
                <div class="space-y-2">
                    <a href="<?php echo e(route('admin.borrows.pending')); ?>" class="w-full block text-center bg-yellow-600 text-white px-4 py-2 rounded hover:bg-yellow-700 transition-colors relative">
                        Pending Requests
                    ...
                    <a href="<?php echo e(route('admin.borrows.borrowed')); ?>" class="w-full block text-center bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors">
                        All Borrowed Books
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-l-4 border-purple-500">
            <div class="p-6">
                ...
                <a href="<?php echo e(route('admin.discussion_rooms.index')); ?>" class="w-full block text-center bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition-colors">
                    Manage Rooms
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-l-4 border-orange-500">
            <div class="p-6">
                ...
                <a href="<?php echo e(route('admin.discussion_rooms.index')); ?>" class="w-full block text-center bg-orange-600 text-white px-4 py-2 rounded hover:bg-orange-700 transition-colors">
                    View Reservations
                </a>
        ...
        <div class="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-l-4 border-red-500">
            <div class="p-6">
                ...
                <div class="space-y-2">
                    <a href="<?php echo e(route('admin.lost_items.index')); ?>" class="w-full block text-center bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition-colors">
                        View Lost Items
                    </a>
                    <a href="<?php echo e(route('admin.lost_items.create')); ?>" class="w-full block text-center bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition-colors">
                        Report Lost Item
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git\Final-Library-System-Capstone-1\final-1\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>