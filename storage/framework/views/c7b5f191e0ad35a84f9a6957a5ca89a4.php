    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="rounded-lg border bg-white shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="p-6">
                ...
                <a href="<?php echo e(route('borrowed.books')); ?>"
        ...
        <div class="rounded-lg border bg-white shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="p-6">
                ...
                <a href="<?php echo e(route('pc-room.index')); ?>"
                    class="inline-flex items-center justify-center rounded-md text-sm font-medium bg-orange-600 text-white hover:bg-orange-700 h-10 px-4 py-2 w-full transition duration-200">
                    Book PC
                </a>
            </div>
        ...
        <div class="rounded-lg border bg-white shadow-sm hover:shadow-md transition-shadow duration-200">
            <div class="p-6">
                ...
                <a href="<?php echo e(route('lost_items.index')); ?>"
                    class="inline-flex items-center justify-center rounded-md text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 h-10 px-4 py-2 w-full transition duration-200">
                    View Lost Items
                </a>
            </div>
                ...
                <div class="p-4 rounded-lg bg-gray-50 border hover:border-red-200 transition-colors duration-200">
                    <div class="grid gap-2">
                        <div class="flex justify-between items-start">
                            <h3 class="font-semibold text-red-600"><?php echo e($borrow->book->title); ?></h3>
                            <span class="text-sm px-3 py-1 rounded-full <?php echo e(\Carbon\Carbon::parse($borrow->due_date)->isPast() ? 'bg-red-100 text-red-600' : 'bg-orange-100 text-orange-600'); ?>">
                                Due: <?php echo e(\Carbon\Carbon::parse($borrow->due_date)->format('M d, Y')); ?>

                            </span>
                        </div>
                        <p class="text-sm text-gray-600">By <?php echo e($borrow->book->author); ?></p>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-500">
                                Borrowed on <?php echo e(\Carbon\Carbon::parse($borrow->borrowed_date)->format('M d, Y')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git\Final-Library-System-Capstone-1\final-1\resources\views/dashboard.blade.php ENDPATH**/ ?>